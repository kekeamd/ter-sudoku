...
- Estimation de difficulté d'une Grille via Techniques Humaine,

- Le traçage de la résolution d'une grille,

- Un historique permettant d'enregister et de restituer un séquence de Grille,

- Un Parser Permettant le transtypage notamment pour la Grille,

- Un système de sauvegarde et de restitution de Grille précédemment générer,

- Un système permettant de récupérer l'estimation de la difficulté faite par un site Externe : SudokuCoach(Numero),

- Un affichage console permettant l'affichage et l'interaction avec les fonctionnalités implémenter ainsi que jouer,

- Demande de génération de d'affichage de Grille dans une Page WEB,
