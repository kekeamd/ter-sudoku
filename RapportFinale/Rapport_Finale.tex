...
\subsubsection{Exemples d'affichage de l'interface console}

Les figures suivantes montrent l'affichage de l'interface console après le choix d'une difficulté. 
La grille est chargée depuis la banque de grilles pré-générées, puis le programme affiche la difficulté estimée, le nombre d'étapes nécessaires et la technique maximale utilisée.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{grilleFacile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{grilleDifficile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{grilleExtremeResolu.png}
    \caption{Exemple d'une grille extrême resolue avec des techniques humaines dans l'interface console}
    \label{fig:grille-difficile}
\end{figure}
