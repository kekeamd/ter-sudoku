...
\textbf{Participants :} Tous les membres de l’équipe du projet Sudoku et notre encadrant.
...
\begin{itemize}
  ...
  \item \textbf{Bibliothèques utilisées :} utilisation possible de modules standards (random, os, mathplotlib, shutil) et d’outils de visualisation simples pour l’interface de test.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{figure1.jpeg}
  \caption{Statistiques de solveur sous forme de graphe}
\end{figure}
...
\begin{itemize}
  \item \textbf{KONCHEV Martin :} Conception et implémentation des algorithmes de génération de grilles et du solveur de Sudoku (backtracking); Analyse des statistiques et de la complexité; Compteur de solutions possibles (optimisé); Création de l’interface console; Rapport.
  \item \textbf{BRIOT-AMADIUE Kellyan :} Implémentation des algorithmes de parsing des grilles de Sudoku à partir de fichiers texte; Réalisation de tests fréquents afin de valider les fonctionnalités principales du projet; Compteur de solutions possibles (base); Analyse des statistiques.
  \item \textbf{BARRE-GUEROT Ilan :} Débogage du programme; Gestion du déroulement step by step dans l’interface console; Préparation de l’affichage des étapes successives et mise en place de la navigation dans l’historique des grilles.
  \item \textbf{DOLO Abdourahamane-Abdoul :} Mise en place d’une version fonctionnelle du parseur de grilles; Validation des données; Réalisation de tests unitaires pour vérifier des fonctions crées.
\end{itemize}
