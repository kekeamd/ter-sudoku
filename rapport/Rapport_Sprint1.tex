...
\begin{itemize}
  \item \textbf{KONCHEV Martin :} Conception et implémentation des algorithmes de génération de grilles et du solveur de Sudoku (backtracking); Analyse des statistiques et de la complexité; Création de l’interface console; Rapport.
  \item \textbf{BRIOT-AMADIUE Kellyan :} Implémentation des algorithmes de parsing des grilles de Sudoku à partir de fichiers texte; Réalisation de tests fréquents afin de valider les fonctionnalités principales du projet.
